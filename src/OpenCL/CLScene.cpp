...
namespace
{
	...
	size_t findMaterialIndex(const std::vector<Material>& materials, uint materialId)
	{
	...
	int findTextureIndex(const std::vector<ImageTexture>& textures, uint textureId)
	{
