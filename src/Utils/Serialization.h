...
namespace Raycer
{
	...
	void serialize(Archive& a, Material& b)
	{
		a(cereal::make_nvp("id", b.id),
			...
			cereal::make_nvp("bumpMapTextureId", b.bumpMapTextureId),
			cereal::make_nvp("displacementMapTextureId", b.displacementMapTextureId),
			cereal::make_nvp("texcoordScale", b.texcoordScale),
			cereal::make_nvp("hasBumpMap", b.hasBumpMap),
			cereal::make_nvp("hasDisplacementMap", b.hasDisplacementMap),
			...
			cereal::make_nvp("attenuates", b.attenuates),
			cereal::make_nvp("attenuation", b.attenuation),
