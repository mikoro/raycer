...
namespace
{
	...
	void processMaterialFile(const std::string& objFileDirectory, const std::string& mtlFilePath, const ModelLoaderInfo& info, ModelLoaderResult& result, std::map<std::string, int>& materialsMap, int& currentId)
	{
