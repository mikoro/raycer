...
Scene Scene::createTestScene8()
{
	...
	sphere5Material.textureId = sphere5Texture.id;
	...
	sphere6Material.textureId = sphere6Texture.id;
	...
	sphere7Material.textureId = sphere7Texture.id;
	...
	sphere8Material.textureId = sphere8Texture.id;
	...
	sphere9Material.textureId = sphere9Texture.id;
	...
	sphere10Material.textureId = sphere10Texture.id;
	...
	sphere11Material.textureId = sphere11Texture.id;
	...
	sphere12Material.textureId = sphere12Texture.id;
	...
	sphere13Material.textureId = sphere13Texture.id;
